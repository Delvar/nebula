...
import {default as LayerNebula3} from './LayerNebula3.js';
import {default as LayerMilkyWay3} from './LayerMilkyWay3.js';
import {default as LayerPointStars} from './LayerPointStars.js';
import {default as LayerBigStars} from './LayerBigStars.js';


var LayerNebula = LayerNebula3;
var LayerMilkyWay = LayerMilkyWay3;

//['Colour', 'Random', 'Layer', 'LayerPointStars', 'LayerBigStars', 'LayerBrightStar', 'LayerNebula', 'LayerNebula2', 'LayerNebula3', 'LayerNebula4', 'LayerVignette', 'LayerMilkyWay', 'LayerMilkyWay2', 'LayerMilkyWay3', 'Random/SeedRandom'],
...
console.log(Random);
var seedRandom = new Random.SeedRandom();

console.log(Colour);
var colour = new Colour.Hsla(seedRandom.between(0, 1), seedRandom.between(0, 1), seedRandom.between(0.25, 1), seedRandom.between(0.5, 1));
console.log(colour);
